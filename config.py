...
OUTPUT_FILE = os.path.join(BASE_DIR, "auto_post", "auto_post_reels", "temp", "temp_video.mp4")
AUDIO_PATH = os.path.join(BASE_DIR, "auto_post", "auto_post_reels", "reel_sounds")
FONT_PATH = os.path.join(BASE_DIR, "auto_post", "auto_post_reels", "reel_fonts", "SuperCaramel-5yBza.ttf")
